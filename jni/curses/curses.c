...
//~ jstring
//~ Java_com_crawlmb_NativeWrapper_gameStart( JNIEnv* env1,
                                                  //~ jobject obj1,
                                                  //~ jint argc,
                                                  //~ jobjectArray argv )
//~ JNIEXPORT void JNICALL gameStart (JNIEnv *env1, jobject obj1, jint argc, jobjectArray argv)
//~ void Java_com_crawlmb_NativeWrapper_gameStart( JNIEnv* env1, jobject obj1 , jint argc, jobjectArray argv)
