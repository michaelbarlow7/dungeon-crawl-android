...
//	native void gameStart(int argc, String[] argv);
	...
	/*
	 * Not sure what these two methods do native int gameQueryInt(int argc,
	 * String[] argv); native String gameQueryString(int argc, String[] argv);
	 */
